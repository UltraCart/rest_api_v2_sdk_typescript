...
import {
    ...
    ConversationAgentStatusConfigResponseFromJSON,
    ConversationAgentStatusConfigResponseToJSON,
    ConversationAgentStatusConfigsResponse,
    ConversationAgentStatusConfigsResponseFromJSON,
    ConversationAgentStatusConfigsResponseToJSON,
    ConversationAgentStatusHeatmapRequest,
    ConversationAgentStatusHeatmapRequestFromJSON,
    ConversationAgentStatusHeatmapRequestToJSON,
    ConversationAgentStatusHeatmapResponse,
    ConversationAgentStatusHeatmapResponseFromJSON,
    ConversationAgentStatusHeatmapResponseToJSON,
    ConversationAgentStatusHistorySearchRequest,
    ConversationAgentStatusHistorySearchRequestFromJSON,
    ConversationAgentStatusHistorySearchRequestToJSON,
    ConversationAgentStatusHistorySearchResponse,
    ConversationAgentStatusHistorySearchResponseFromJSON,
    ConversationAgentStatusHistorySearchResponseToJSON,
    ConversationAgentStatusRollupSearchRequest,
    ConversationAgentStatusRollupSearchRequestFromJSON,
    ConversationAgentStatusRollupSearchRequestToJSON,
    ConversationAgentStatusRollupSearchResponse,
    ConversationAgentStatusRollupSearchResponseFromJSON,
    ConversationAgentStatusRollupSearchResponseToJSON,
    ConversationAgentStatusSummaryResponse,
    ConversationAgentStatusSummaryResponseFromJSON,
    ConversationAgentStatusSummaryResponseToJSON,
    ...
    ConversationPbxDefaultTimezoneResponseFromJSON,
    ConversationPbxDefaultTimezoneResponseToJSON,
    ConversationPbxDefaultTimezoneUpdateRequest,
    ConversationPbxDefaultTimezoneUpdateRequestFromJSON,
    ConversationPbxDefaultTimezoneUpdateRequestToJSON,
    ...
    ConversationPbxPayConnectorsResponseFromJSON,
    ConversationPbxPayConnectorsResponseToJSON,
...
export interface DeleteAgentStatusConfigRequest {
...
export interface GetAgentStatusHeatmapRequest {
    heatmapRequest: ConversationAgentStatusHeatmapRequest;
}

export interface GetAgentStatusSummaryRequest {
    dateStart2: string;
    dateEnd2: string;
    dateStart?: string;
    dateEnd?: string;
...
export interface GetAgentStatusTimelineRequest {
    agentUserId: string;
    date2: string;
    date?: string;
    channel?: string;
...
export interface InsertAgentStatusConfigRequest {
    statusConfig: ConversationAgentStatusConfig;
}
...
export interface SearchAgentStatusHistoryRequest {
    searchRequest: ConversationAgentStatusHistorySearchRequest;
    limit?: number;
    offset?: number;
}

export interface SearchAgentStatusRollupsRequest {
    searchRequest: ConversationAgentStatusRollupSearchRequest;
}
...
export interface UpdateAgentStatusConfigRequest {
    conversationStatusUuid: string;
    statusConfig: ConversationAgentStatusConfig;
}
...
export interface UpdatePbxDefaultTimezoneRequest {
    timezoneUpdate: ConversationPbxDefaultTimezoneUpdateRequest;
}
...
export interface ConversationApiInterface {
     ...
     * @param {string} conversationStatusUuid 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    deleteAgentStatusConfigRaw(requestParameters: DeleteAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Sets active=false on the row and the DDB sync record. The Twilio Activity is preserved (Round 2 decision) so historic worker reporting still resolves the SID. 
     * Soft-deactivate a custom agent status
     */
    deleteAgentStatusConfig(requestParameters: DeleteAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof ConversationApiInterface
     */
    getAgentStatusConfigsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigsResponse>>;

    /**
     * Returns all custom statuses (active and soft-deactivated) for the merchant. 
     * List custom agent statuses
     */
    getAgentStatusConfigs(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigsResponse>;
     ...
     * @param {ConversationAgentStatusHeatmapRequest} heatmapRequest Heatmap request
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    getAgentStatusHeatmapRaw(requestParameters: GetAgentStatusHeatmapRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusHeatmapResponse>>;

    /**
     * Returns ECharts-shaped agent x hour grid for the requested metric (availability, call_volume, chat_volume). Multi-day requests average the cell values across the date range. 
     * Agent x hour-of-day heatmap
     */
    getAgentStatusHeatmap(requestParameters: GetAgentStatusHeatmapRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusHeatmapResponse>;
     ...
     * @param {string} dateStart2 Range start (YYYY-MM-DD)
     * @param {string} dateEnd2 Range end (YYYY-MM-DD)
     ...
     * @memberof ConversationApiInterface
     */
    getAgentStatusSummaryRaw(requestParameters: GetAgentStatusSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusSummaryResponse>>;

    /**
     * Top-line summary: total_agents, avg_available_pct, status_breakdown, per-agent rollups. 
     * Dashboard summary for a date range
     */
    getAgentStatusSummary(requestParameters: GetAgentStatusSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusSummaryResponse>;
     ...
     * @param {string} [channel2] Restrict to one channel (omit for both)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    getAgentStatusTimelineRaw(requestParameters: GetAgentStatusTimelineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusTimelineResponse>>;

    /**
     * Returns merged status events + PBX calls + chat conversations for the agent on the given date. Omitting the channel parameter returns both channels merged. 
     * Day timeline for a single agent
     */
    getAgentStatusTimeline(requestParameters: GetAgentStatusTimelineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusTimelineResponse>;
     ...
     * @memberof ConversationApiInterface
     */
    getPbxDefaultTimezoneRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxDefaultTimezoneResponse>>;

    /**
     * Returns the merchant\'s stored default timezone (IANA name). Falls back to America/New_York when unset. 
     * Get the merchant default timezone
     */
    getPbxDefaultTimezone(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxDefaultTimezoneResponse>;
     ...
     * @summary Get pbx pay connectors
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    getPbxPayConnectorsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxPayConnectorsResponse>>;

    /**
     * Retrieve the Twilio Pay Connectors installed in the Twilio account for this merchant.  This list is refreshed each time the PBX configuration is deployed. 
     * Get pbx pay connectors
     */
    getPbxPayConnectors(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxPayConnectorsResponse>;
     ...
     * @param {ConversationAgentStatusConfig} statusConfig Status config
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    insertAgentStatusConfigRaw(requestParameters: InsertAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigResponse>>;

    /**
     * Create a custom status. Enforces a 20-active-status-per-merchant cap and the 50-Twilio-Activity-per-workspace cap. 
     * Create a custom agent status
     */
    insertAgentStatusConfig(requestParameters: InsertAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigResponse>;
     ...
     * @param {ConversationAgentStatusHistorySearchRequest} searchRequest Search request
     * @param {number} [limit] Maximum records per call (max 200)
     * @param {number} [offset] Pagination offset (zero-based)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    searchAgentStatusHistoryRaw(requestParameters: SearchAgentStatusHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusHistorySearchResponse>>;

    /**
     * Paginated search over conversation_agent_status_events_all. Filters: agent_user_id, channel, status, trigger, date range. 
     * Search agent status history
     */
    searchAgentStatusHistory(requestParameters: SearchAgentStatusHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusHistorySearchResponse>;
     ...
     * @param {ConversationAgentStatusRollupSearchRequest} searchRequest Search request
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    searchAgentStatusRollupsRaw(requestParameters: SearchAgentStatusRollupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusRollupSearchResponse>>;

    /**
     * Aggregated over conversation_agent_status_events_all via date_histogram + terms. Returns one row per (agent, day, channel). 
     * Search per-(agent, day) rollups
     */
    searchAgentStatusRollups(requestParameters: SearchAgentStatusRollupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusRollupSearchResponse>;
     ...
     * @memberof ConversationApiInterface
     */
    updateAgentStatusConfigRaw(requestParameters: UpdateAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigResponse>>;

    /**
     * Update a custom status. Renaming flows through to the Twilio Activity. 
     * Update a custom agent status
     */
    updateAgentStatusConfig(requestParameters: UpdateAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigResponse>;
     ...
     * @param {ConversationPbxDefaultTimezoneUpdateRequest} timezoneUpdate Timezone update
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ConversationApiInterface
     */
    updatePbxDefaultTimezoneRaw(requestParameters: UpdatePbxDefaultTimezoneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxDefaultTimezoneResponse>>;

    /**
     * Persists the IANA timezone on the Config#<merchant_id>/default DDB record (creates on first PUT). 
     * Set the merchant default timezone
     */
    updatePbxDefaultTimezone(requestParameters: UpdatePbxDefaultTimezoneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxDefaultTimezoneResponse>;
...
export class ConversationApi extends runtime.BaseAPI implements ConversationApiInterface {
     ...
     * Soft-deactivate a custom agent status
     */
    async deleteAgentStatusConfigRaw(requestParameters: DeleteAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.conversationStatusUuid === null || requestParameters.conversationStatusUuid === undefined) {
            throw new runtime.RequiredError('conversationStatusUuid','Required parameter requestParameters.conversationStatusUuid was null or undefined when calling deleteAgentStatusConfig.');
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/config/{conversation_status_uuid}`.replace(`{${"conversation_status_uuid"}}`, encodeURIComponent(String(requestParameters.conversationStatusUuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Soft-deactivate a custom agent status
     */
    async deleteAgentStatusConfig(requestParameters: DeleteAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteAgentStatusConfigRaw(requestParameters, initOverrides);
    }
     ...
     * List custom agent statuses
     */
    async getAgentStatusConfigsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigsResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/conversation/agent/status/config`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusConfigsResponseFromJSON(jsonValue));
    }
     ...
     * List custom agent statuses
     */
    async getAgentStatusConfigs(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigsResponse> {
        const response = await this.getAgentStatusConfigsRaw(initOverrides);
        return await response.value();
    }
     ...
     * Agent x hour-of-day heatmap
     */
    async getAgentStatusHeatmapRaw(requestParameters: GetAgentStatusHeatmapRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusHeatmapResponse>> {
        if (requestParameters.heatmapRequest === null || requestParameters.heatmapRequest === undefined) {
            throw new runtime.RequiredError('heatmapRequest','Required parameter requestParameters.heatmapRequest was null or undefined when calling getAgentStatusHeatmap.');
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/heatmap`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ConversationAgentStatusHeatmapRequestToJSON(requestParameters.heatmapRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusHeatmapResponseFromJSON(jsonValue));
    }
     ...
     * Agent x hour-of-day heatmap
     */
    async getAgentStatusHeatmap(requestParameters: GetAgentStatusHeatmapRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusHeatmapResponse> {
        const response = await this.getAgentStatusHeatmapRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Dashboard summary for a date range
     */
    async getAgentStatusSummaryRaw(requestParameters: GetAgentStatusSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusSummaryResponse>> {
        if (requestParameters.dateStart2 === null || requestParameters.dateStart2 === undefined) {
            throw new runtime.RequiredError('dateStart2','Required parameter requestParameters.dateStart2 was null or undefined when calling getAgentStatusSummary.');
        }

        if (requestParameters.dateEnd2 === null || requestParameters.dateEnd2 === undefined) {
            throw new runtime.RequiredError('dateEnd2','Required parameter requestParameters.dateEnd2 was null or undefined when calling getAgentStatusSummary.');
        }
        ...
        if (requestParameters.dateStart2 !== undefined) {
            queryParameters['date_start'] = requestParameters.dateStart2;
        }

        if (requestParameters.dateEnd2 !== undefined) {
            queryParameters['date_end'] = requestParameters.dateEnd2;
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/rollup/summary`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusSummaryResponseFromJSON(jsonValue));
    }
     ...
     * Dashboard summary for a date range
     */
    async getAgentStatusSummary(requestParameters: GetAgentStatusSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusSummaryResponse> {
        const response = await this.getAgentStatusSummaryRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Day timeline for a single agent
     */
    async getAgentStatusTimelineRaw(requestParameters: GetAgentStatusTimelineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusTimelineResponse>> {
        if (requestParameters.agentUserId === null || requestParameters.agentUserId === undefined) {
            throw new runtime.RequiredError('agentUserId','Required parameter requestParameters.agentUserId was null or undefined when calling getAgentStatusTimeline.');
        }

        if (requestParameters.date2 === null || requestParameters.date2 === undefined) {
            throw new runtime.RequiredError('date2','Required parameter requestParameters.date2 was null or undefined when calling getAgentStatusTimeline.');
        }
        ...
        if (requestParameters.date2 !== undefined) {
            queryParameters['date'] = requestParameters.date2;
        }

        if (requestParameters.channel2 !== undefined) {
            queryParameters['channel'] = requestParameters.channel2;
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/history/{agent_user_id}/timeline`.replace(`{${"agent_user_id"}}`, encodeURIComponent(String(requestParameters.agentUserId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusTimelineResponseFromJSON(jsonValue));
    }
     ...
     * Day timeline for a single agent
     */
    async getAgentStatusTimeline(requestParameters: GetAgentStatusTimelineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusTimelineResponse> {
        const response = await this.getAgentStatusTimelineRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get the merchant default timezone
     */
    async getPbxDefaultTimezoneRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxDefaultTimezoneResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/conversation/pbx/config/default-timezone`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationPbxDefaultTimezoneResponseFromJSON(jsonValue));
    }
     ...
     * Get the merchant default timezone
     */
    async getPbxDefaultTimezone(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxDefaultTimezoneResponse> {
        const response = await this.getPbxDefaultTimezoneRaw(initOverrides);
        return await response.value();
    }
     ...
     * Get pbx pay connectors
     */
    async getPbxPayConnectorsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxPayConnectorsResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/conversation/pbx/pay_connector`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationPbxPayConnectorsResponseFromJSON(jsonValue));
    }
     ...
     * Get pbx pay connectors
     */
    async getPbxPayConnectors(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxPayConnectorsResponse> {
        const response = await this.getPbxPayConnectorsRaw(initOverrides);
        return await response.value();
    }
     ...
     * Create a custom agent status
     */
    async insertAgentStatusConfigRaw(requestParameters: InsertAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigResponse>> {
        if (requestParameters.statusConfig === null || requestParameters.statusConfig === undefined) {
            throw new runtime.RequiredError('statusConfig','Required parameter requestParameters.statusConfig was null or undefined when calling insertAgentStatusConfig.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ConversationAgentStatusConfigToJSON(requestParameters.statusConfig),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusConfigResponseFromJSON(jsonValue));
    }
     ...
     * Create a custom agent status
     */
    async insertAgentStatusConfig(requestParameters: InsertAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigResponse> {
        const response = await this.insertAgentStatusConfigRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Search agent status history
     */
    async searchAgentStatusHistoryRaw(requestParameters: SearchAgentStatusHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusHistorySearchResponse>> {
        if (requestParameters.searchRequest === null || requestParameters.searchRequest === undefined) {
            throw new runtime.RequiredError('searchRequest','Required parameter requestParameters.searchRequest was null or undefined when calling searchAgentStatusHistory.');
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/history/search`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ConversationAgentStatusHistorySearchRequestToJSON(requestParameters.searchRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusHistorySearchResponseFromJSON(jsonValue));
    }
     ...
     * Search agent status history
     */
    async searchAgentStatusHistory(requestParameters: SearchAgentStatusHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusHistorySearchResponse> {
        const response = await this.searchAgentStatusHistoryRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Search per-(agent, day) rollups
     */
    async searchAgentStatusRollupsRaw(requestParameters: SearchAgentStatusRollupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusRollupSearchResponse>> {
        if (requestParameters.searchRequest === null || requestParameters.searchRequest === undefined) {
            throw new runtime.RequiredError('searchRequest','Required parameter requestParameters.searchRequest was null or undefined when calling searchAgentStatusRollups.');
        }
        ...
        const response = await this.request({
            path: `/conversation/agent/status/rollup/search`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ConversationAgentStatusRollupSearchRequestToJSON(requestParameters.searchRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ConversationAgentStatusRollupSearchResponseFromJSON(jsonValue));
    }
     ...
     * Search per-(agent, day) rollups
     */
    async searchAgentStatusRollups(requestParameters: SearchAgentStatusRollupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusRollupSearchResponse> {
        const response = await this.searchAgentStatusRollupsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update a custom agent status
     */
    async updateAgentStatusConfigRaw(requestParameters: UpdateAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationAgentStatusConfigResponse>> {
        if (requestParameters.conversationStatusUuid === null || requestParameters.conversationStatusUuid === undefined) {
            throw new runtime.RequiredError('conversationStatusUuid','Required parameter requestParameters.conversationStatusUuid was null or undefined when calling updateAgentStatusConfig.');
        }

        if (requestParameters.statusConfig === null || requestParameters.statusConfig === undefined) {
            throw new runtime.RequiredError('statusConfig','Required parameter requestParameters.statusConfig was null or undefined when calling updateAgentStatusConfig.');
        }
     ...
     * Update a custom agent status
     */
    async updateAgentStatusConfig(requestParameters: UpdateAgentStatusConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationAgentStatusConfigResponse> {
        const response = await this.updateAgentStatusConfigRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Set the merchant default timezone
     */
    async updatePbxDefaultTimezoneRaw(requestParameters: UpdatePbxDefaultTimezoneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConversationPbxDefaultTimezoneResponse>> {
        if (requestParameters.timezoneUpdate === null || requestParameters.timezoneUpdate === undefined) {
            throw new runtime.RequiredError('timezoneUpdate','Required parameter requestParameters.timezoneUpdate was null or undefined when calling updatePbxDefaultTimezone.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ConversationPbxDefaultTimezoneUpdateRequestToJSON(requestParameters.timezoneUpdate),
        }, initOverrides);
     ...
     * Set the merchant default timezone
     */
    async updatePbxDefaultTimezone(requestParameters: UpdatePbxDefaultTimezoneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConversationPbxDefaultTimezoneResponse> {
        const response = await this.updatePbxDefaultTimezoneRaw(requestParameters, initOverrides);
        return await response.value();
    }
