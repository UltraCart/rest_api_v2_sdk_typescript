...
const MY_INTERFACE_KEYS: (keyof ConversationWebchatQueueStatusQueueEntry)[] = ["conversation_participant_arn", "conversation_participant_name", "conversation_webchat_queue_uuid", "email", "join_dts", "participant_language_iso_code", "question", "queue_name"];
