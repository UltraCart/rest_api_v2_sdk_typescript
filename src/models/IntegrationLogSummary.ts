...
const MY_INTERFACE_KEYS: (keyof IntegrationLogSummary)[] = ["critical", "error", "events", "log_type", "logger_id", "logger_name", "success", "view_url", "warning"];
...
/**
 * Check if a given object implements the IntegrationLogSummary interface.
 */
export function instanceOfIntegrationLogSummary(value: object): boolean {
    let isInstance = true;
