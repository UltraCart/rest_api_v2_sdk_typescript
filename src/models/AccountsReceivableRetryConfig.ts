...
/**
 * Check if a given object implements the AccountsReceivableRetryConfig interface.
 */
export function instanceOfAccountsReceivableRetryConfig(value: object): boolean {
    let isInstance = true;
