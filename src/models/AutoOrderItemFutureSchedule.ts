...
/**
 * Check if a given object implements the AutoOrderItemFutureSchedule interface.
 */
export function instanceOfAutoOrderItemFutureSchedule(value: object): boolean {
    let isInstance = true;
