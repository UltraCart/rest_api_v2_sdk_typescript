...
const MY_INTERFACE_KEYS: (keyof ScreenshotsResponse)[] = ["error", "metadata", "screenshots", "success", "warning"];
...
/**
 * Check if a given object implements the ScreenshotsResponse interface.
 */
export function instanceOfScreenshotsResponse(value: object): boolean {
    let isInstance = true;
