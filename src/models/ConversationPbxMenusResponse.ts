...
export function ConversationPbxMenusResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationPbxMenusResponse {
...
export function ConversationPbxMenusResponseToJSON(value?: ConversationPbxMenusResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
