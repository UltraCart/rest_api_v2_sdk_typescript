...
const MY_INTERFACE_KEYS: (keyof OrderFormatResponse)[] = ["css_links", "formatted_result"];
...
/**
 * Check if a given object implements the OrderFormatResponse interface.
 */
export function instanceOfOrderFormatResponse(value: object): boolean {
    let isInstance = true;
