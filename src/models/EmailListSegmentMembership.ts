...
const MY_INTERFACE_KEYS: (keyof EmailListSegmentMembership)[] = ["email_list_uuid", "email_segment_uuid", "exclude", "name"];
...
/**
 * Check if a given object implements the EmailListSegmentMembership interface.
 */
export function instanceOfEmailListSegmentMembership(value: object): boolean {
    let isInstance = true;
