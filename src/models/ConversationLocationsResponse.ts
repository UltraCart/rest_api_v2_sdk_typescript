...
const MY_INTERFACE_KEYS: (keyof ConversationLocationsResponse)[] = ["countries", "error", "metadata", "success", "warning"];
...
/**
 * Check if a given object implements the ConversationLocationsResponse interface.
 */
export function instanceOfConversationLocationsResponse(value: object): boolean {
    let isInstance = true;
