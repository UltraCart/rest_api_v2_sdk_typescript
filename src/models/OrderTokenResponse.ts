...
const MY_INTERFACE_KEYS: (keyof OrderTokenResponse)[] = ["error", "metadata", "order_token", "success", "warning"];
...
/**
 * Check if a given object implements the OrderTokenResponse interface.
 */
export function instanceOfOrderTokenResponse(value: object): boolean {
    let isInstance = true;
