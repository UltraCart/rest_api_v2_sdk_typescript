...
const MY_INTERFACE_KEYS: (keyof ItemPaymentProcessing)[] = ["block_prepaid", "block_refunds", "credit_card_transaction_type", "no_realtime_charge", "payment_method_validity", "rotating_transaction_gateway_codes"];
