...
const MY_INTERFACE_KEYS: (keyof EmailFlowFoldersResponse)[] = ["error", "flow_folders", "metadata", "success", "warning"];
...
/**
 * Check if a given object implements the EmailFlowFoldersResponse interface.
 */
export function instanceOfEmailFlowFoldersResponse(value: object): boolean {
    let isInstance = true;
