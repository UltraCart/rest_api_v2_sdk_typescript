...
const MY_INTERFACE_KEYS: (keyof OrderPaymentTransaction)[] = ["details", "successful", "transaction_gateway", "transaction_id", "transaction_timestamp"];
...
/**
 * Check if a given object implements the OrderPaymentTransaction interface.
 */
export function instanceOfOrderPaymentTransaction(value: object): boolean {
    let isInstance = true;
