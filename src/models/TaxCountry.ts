...
/**
 * Check if a given object implements the TaxCountry interface.
 */
export function instanceOfTaxCountry(value: object): boolean {
    let isInstance = true;
...
export function TaxCountryFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaxCountry {
    ...
    return {
        ...
        'vat_threshold': !exists(json, 'vat_threshold') ? undefined : json['vat_threshold'],
        'vat_threshold_currency': !exists(json, 'vat_threshold_currency') ? undefined : json['vat_threshold_currency'],
    };
}
...
export function TaxCountryToJSON(value?: TaxCountry | null): any {
    ...
    return {
        ...
        'vat_threshold': value.vat_threshold,
        'vat_threshold_currency': value.vat_threshold_currency,
    };
}
