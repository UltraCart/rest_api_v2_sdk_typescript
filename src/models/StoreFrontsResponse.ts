...
const MY_INTERFACE_KEYS: (keyof StoreFrontsResponse)[] = ["error", "metadata", "storeFronts", "success", "warning"];
...
/**
 * Check if a given object implements the StoreFrontsResponse interface.
 */
export function instanceOfStoreFrontsResponse(value: object): boolean {
    let isInstance = true;
