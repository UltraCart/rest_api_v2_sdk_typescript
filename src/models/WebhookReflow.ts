...
const MY_INTERFACE_KEYS: (keyof WebhookReflow)[] = ["event_name", "queued"];
...
/**
 * Check if a given object implements the WebhookReflow interface.
 */
export function instanceOfWebhookReflow(value: object): boolean {
    let isInstance = true;
