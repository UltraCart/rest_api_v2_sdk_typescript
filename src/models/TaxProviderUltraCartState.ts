...
const MY_INTERFACE_KEYS: (keyof TaxProviderUltraCartState)[] = ["enabled", "exempt_digital_items", "exempt_physical_items", "exempt_service_items", "state_code", "state_name", "tax_gift_charge", "tax_gift_wrap", "tax_rate_formatted", "tax_shipping"];
