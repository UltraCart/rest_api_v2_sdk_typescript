...
const MY_INTERFACE_KEYS: (keyof OrderPaymentCreditCardDualVaultedProperty)[] = ["name", "value"];
...
/**
 * Check if a given object implements the OrderPaymentCreditCardDualVaultedProperty interface.
 */
export function instanceOfOrderPaymentCreditCardDualVaultedProperty(value: object): boolean {
    let isInstance = true;
