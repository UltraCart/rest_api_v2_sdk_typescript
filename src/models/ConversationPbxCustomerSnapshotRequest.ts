...
const MY_INTERFACE_KEYS: (keyof ConversationPbxCustomerSnapshotRequest)[] = ["auto_order_expand", "customer_expand", "error", "metadata", "order_expand", "phone_number", "success", "warning"];
