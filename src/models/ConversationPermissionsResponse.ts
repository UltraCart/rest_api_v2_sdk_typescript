...
const MY_INTERFACE_KEYS: (keyof ConversationPermissionsResponse)[] = ["error", "metadata", "permissions", "success", "warning"];
...
/**
 * Check if a given object implements the ConversationPermissionsResponse interface.
 */
export function instanceOfConversationPermissionsResponse(value: object): boolean {
    let isInstance = true;
