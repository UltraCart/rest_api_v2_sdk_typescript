...
/**
 * Check if a given object implements the CouponFreeItemWithItemPurchase interface.
 */
export function instanceOfCouponFreeItemWithItemPurchase(value: object): boolean {
    let isInstance = true;
