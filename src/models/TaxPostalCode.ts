...
const MY_INTERFACE_KEYS: (keyof TaxPostalCode)[] = ["accounting_code", "city_oid", "dont_collect_postal_code", "postal_code", "postal_code_oid", "tax_rate", "tax_rate_formatted"];
...
/**
 * Check if a given object implements the TaxPostalCode interface.
 */
export function instanceOfTaxPostalCode(value: object): boolean {
    let isInstance = true;
