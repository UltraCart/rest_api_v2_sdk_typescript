...
const MY_INTERFACE_KEYS: (keyof PublishLibraryItemRequest)[] = ["release_notes"];
...
/**
 * Check if a given object implements the PublishLibraryItemRequest interface.
 */
export function instanceOfPublishLibraryItemRequest(value: object): boolean {
    let isInstance = true;
