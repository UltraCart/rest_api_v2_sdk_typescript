...
const MY_INTERFACE_KEYS: (keyof ConversationMessagesResponse)[] = ["conversation_messages", "error", "metadata", "success", "warning"];
...
/**
 * Check if a given object implements the ConversationMessagesResponse interface.
 */
export function instanceOfConversationMessagesResponse(value: object): boolean {
    let isInstance = true;
