...
const MY_INTERFACE_KEYS: (keyof WebhookResponse)[] = ["error", "metadata", "success", "warning", "webhook"];
...
export function WebhookResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookResponse {
    ...
    return {
        ...
        'webhook': !exists(json, 'webhook') ? undefined : WebhookFromJSON(json['webhook']),
    };
}
