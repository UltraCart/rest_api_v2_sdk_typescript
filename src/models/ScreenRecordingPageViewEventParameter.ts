...
const MY_INTERFACE_KEYS: (keyof ScreenRecordingPageViewEventParameter)[] = ["name", "value"];
...
/**
 * Check if a given object implements the ScreenRecordingPageViewEventParameter interface.
 */
export function instanceOfScreenRecordingPageViewEventParameter(value: object): boolean {
    let isInstance = true;
