...
const MY_INTERFACE_KEYS: (keyof UserLoginsResponse)[] = ["error", "logins", "metadata", "success", "warning"];
...
/**
 * Check if a given object implements the UserLoginsResponse interface.
 */
export function instanceOfUserLoginsResponse(value: object): boolean {
    let isInstance = true;
