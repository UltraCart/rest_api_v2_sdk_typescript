...
const MY_INTERFACE_KEYS: (keyof EmailPostcardTrackingResponse)[] = ["error", "metadata", "success", "tracking", "warning"];
...
/**
 * Check if a given object implements the EmailPostcardTrackingResponse interface.
 */
export function instanceOfEmailPostcardTrackingResponse(value: object): boolean {
    let isInstance = true;
