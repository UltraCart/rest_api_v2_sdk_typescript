...
/**
 * Check if a given object implements the EmailCommseqWebhookSendTestRequest interface.
 */
export function instanceOfEmailCommseqWebhookSendTestRequest(value: object): boolean {
    let isInstance = true;
