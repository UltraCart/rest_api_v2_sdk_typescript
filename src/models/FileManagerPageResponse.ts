...
const MY_INTERFACE_KEYS: (keyof FileManagerPageResponse)[] = ["error", "file_manager_page", "metadata", "success", "warning"];
...
/**
 * Check if a given object implements the FileManagerPageResponse interface.
 */
export function instanceOfFileManagerPageResponse(value: object): boolean {
    let isInstance = true;
