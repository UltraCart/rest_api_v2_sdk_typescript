...
const MY_INTERFACE_KEYS: (keyof CouponPercentOffItemsWithItemsPurchase)[] = ["discount_percent", "item_tags", "items", "limit", "required_purchase_items", "required_purchase_items_tags"];
