...
const MY_INTERFACE_KEYS: (keyof EmailRateLimitersResponse)[] = ["error", "metadata", "rate_limiters", "success", "warning"];
...
/**
 * Check if a given object implements the EmailRateLimitersResponse interface.
 */
export function instanceOfEmailRateLimitersResponse(value: object): boolean {
    let isInstance = true;
