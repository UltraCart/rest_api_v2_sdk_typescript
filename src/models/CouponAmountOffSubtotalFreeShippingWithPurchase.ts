...
const MY_INTERFACE_KEYS: (keyof CouponAmountOffSubtotalFreeShippingWithPurchase)[] = ["currency_code", "discount_amount", "purchase_amount", "shipping_methods"];
...
/**
 * Check if a given object implements the CouponAmountOffSubtotalFreeShippingWithPurchase interface.
 */
export function instanceOfCouponAmountOffSubtotalFreeShippingWithPurchase(value: object): boolean {
    let isInstance = true;
